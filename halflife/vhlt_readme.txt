...
1. Open Hammer or Batch Compiler's configuration dialog.
  Set CSG, BSP, VIS, RAD tool pathes to the 'hlcsg.exe', 'hlbsp.exe', 'hlvis.exe', 'hlrad.exe' or 'hlrad_x64.exe' in 'tools' folder.
  'hlrad_x64.exe' is the 64-bit version of 'hlrad.exe'. Use it if you are running 64-bit Windows and want to give hlrad access to 2GB or more system memory.
...
Vluzacn's ZHLT v33 (2014/2/2)
This is Vluzacn's (email: vluzacn@163.com) 33rd custom build of ZHLT 3.4 (http://zhlt.info/)
